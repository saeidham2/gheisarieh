...
//        DB::connection('mysql-apparel')->table('category_apparel_amazing')->insert([
        DB::table('category_apparel_amazing')->insert([
    ...
    {
//        $category2 = DB::connection('mysql-apparel')->table('category_apparel_amazing')
        $category2 = DB::table('category_apparel_amazing')
            ->where('id', $id)->first();
//        $category = DB::connection('mysql-apparel')->table('category_apparel_amazing')
        $category = DB::table('category_apparel_amazing')
...
//        $category = DB::connection('mysql-apparel')->table('category_apparel_amazing')
    ...
    {
//        $amazing2 = DB::connection('mysql-apparel')->table('category_apparel_amazing')
        $amazing2 = DB::table('category_apparel_amazing')
            ->where('id', $id)->first();
//        $amazing = DB::connection('mysql-apparel')->table('category_apparel_amazing')
        $amazing = DB::table('category_apparel_amazing')
            ->where('id', $id)->limit($id);
        $amazing->delete();
        Log::create([
            'user_id' => auth()->user()->id,
...
//            DB::connection('mysql-apparel')->table('category_apparel_amazing')
            DB::table('category_apparel_amazing')
                ...
                latest()->paginate(15) : [];
        return view('livewire.admin.categorypage.apparel.amazing', compact('specialProducts'));
    }
}
